...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *pjvm, void *reserved)
{
   ...
   jclass serialPortClass = env->FindClass("org/ppuc/serialport/SerialPort");
   jmethodID getInstanceMethod = env->GetStaticMethodID(serialPortClass, "getInstance", "()Lorg/ppuc/serialport/SerialPort;");
